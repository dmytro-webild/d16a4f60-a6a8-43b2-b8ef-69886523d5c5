...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/expressive-transgender-posing-medium-shot_23-2149154632.jpg",
          alt: "Expressive transgender posing medium shot",
        },
        {
          ...
          alt: "Pretty young woman with wet hair posing in studio, wearing black oversize blazer and shiny necklace",
        },
        {
          src: "http://img.b2bpic.net/free-photo/bride-pink-robe-puts-eing-her-finger_8353-394.jpg",
          alt: "Bride in pink robe puts eing on her finger",
        },
        {
          src: "http://img.b2bpic.net/free-photo/greyeyed-blonde-curly-woman-white-blouse-pearl-necklace-touches-face-looks-into-camera-walks-outdoors_197531-29992.jpg",
          alt: "Greyeyed blonde curly woman in white blouse and pearl necklace touches face looks into camera and walks outdoors",
        },
      ]}
  ...
  <div id="pillars" data-section="pillars">
      ...
      features={[
        {
          title: "Luminoso",
          description: "Luce pura in ogni dettaglio.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/stylish-ring-with-diamonds_1203-1532.jpg",
          },
          phoneTwo: {
        ...
        {
          title: "Elegante",
          description: "Semplicità che definisce il tuo stile.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/gold-ring_1203-2736.jpg",
          },
          phoneTwo: {
        ...
        {
          title: "Emozionale",
          description: "Custodiamo il tuo ricordo più caro.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/woman-demonstrating-golden-oriental-style-jewelry_114579-12627.jpg",
          },
          phoneTwo: {
  ...
  <div id="best-seller" data-section="best-seller">
      ...
      products={[
        {
          id: "p1",
          brand: "Veyra Gioielli",
          name: "Collana Vera",
          price: "€180",
          rating: 5,
          reviewCount: "128",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-wearing-gold-necklace-with-square-pendant-hoop-earrings_23-2151995439.jpg",
        },
        {
          id: "p2",
          brand: "Veyra Gioielli",
        ...
        },
        {
          id: "p3",
          brand: "Veyra Gioielli",
          name: "Orecchini Hayami",
          price: "€95",
          rating: 4,
          reviewCount: "42",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-engagement-ring-cloth_23-2148966198.jpg",
        },
        {
          id: "p4",
          brand: "Veyra Gioielli",
          name: "Bracciale Essenziale",
          price: "€150",
          rating: 5,
          reviewCount: "56",
      ...
      bulletPoints={[
        {
          ...
          description: "Fatto a mano con amore.",
        },
        {
          title: "Custode di Emozioni",
          description: "Gioielli che raccontano storie.",
        },
        {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Roma",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/laughing-woman-getting-marriage-proposal_23-2147736719.jpg",
        },
        {
          id: "3",
          name: "Sofia M.",
          ...
          company: "Firenze",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-laughing-blonde-woman_329181-2134.jpg",
        },
        {
          id: "4",
          name: "Chiara B.",
          ...
          company: "Torino",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-smiley-woman-posing-seaside_23-2149412670.jpg",
        },
        {
          id: "5",
          name: "Alessia P.",
          ...
          company: "Napoli",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-elegant-woman-black-dress-with-festive-makeup-beautiful-photo-with-bokeh-background_132075-14628.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",
          title: "Quali materiali usate?",
          content: "Usiamo solo metalli nobili e pietre scelte.",
        },
        {
          id: "f2",
          title: "Come scelgo la misura?",
          content: "Consulta la nostra guida alle taglie presente in ogni pagina prodotto.",
        },
        {
          id: "f3",
          title: "Spedizione gratuita?",
          content: "Sì, per tutti gli ordini superiori a 100€.",
        },
        {
          id: "f4",
          title: "Come effettuo un reso?",
          content: "Hai 30 giorni di tempo dalla ricezione per restituire il tuo gioiello.",
        },
      ]}
